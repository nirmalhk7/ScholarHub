...
class CollaborationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaboration" do
    assert_difference('Collaboration.count') do
      post collaborations_url, params: { collaboration: { description: @collaboration.description, fields: @collaboration.fields, title: @collaboration.title, user_id: @collaboration.user_id } }
    end
  ...
  test "should update collaboration" do
    patch collaboration_url(@collaboration), params: { collaboration: { description: @collaboration.description, fields: @collaboration.fields, title: @collaboration.title, user_id: @collaboration.user_id } }
